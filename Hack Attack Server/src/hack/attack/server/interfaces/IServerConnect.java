...
public interface IServerConnect extends Remote{
     ...
     * @param interfaces hashMap of interface that can be used by the server to call the client. Normally those interface are
     ...
     * @param interfaces hashMap of interfaces that can be used by the server to call the client. Normally those interfaces are
     * IClientCreate, IClientUpdate and IClientDelete
     * @return Returns a hashMap<String, IServerUpdate> The string will be the sessionKey and IServerUpdate will be an interface the client
     * can use to communicate with the server while in-game
     */
