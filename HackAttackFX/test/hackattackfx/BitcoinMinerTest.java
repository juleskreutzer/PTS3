...
public class BitcoinMinerTest {
    ...
    public void setUp() {
        ...
        try {
            ...
            bitcoinMinerLv2 = new BitcoinMiner(template1, point2, 50, 50);
            bitcoinMinerLv3 = new BitcoinMiner(template1, point3, 50, 50);
    ...
    public void testActivate() throws InterruptedException {
        ...
        Thread.sleep(4000);
        assertEquals("BitcoinMinerLv1 geeft niet het juiste aantal bitcoins", player1.getBitcoins(), bitcoinMinerLv1.getValuePerSecond());
    }
     ...
     */
    @Test
    public void testSetOnMineListener() throws Exception {
